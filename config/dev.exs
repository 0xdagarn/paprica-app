...
config :paprica, PapricaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "fZ4/FeZpK1Sw+MOxb4t/ypeJS8RBbrDt8tvBidJihiGL/Tpxk76FfCmD97pQDWpg",
  watchers: [
...
config :paprica, PapricaWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/paprica_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :paprica, dev_routes: true
