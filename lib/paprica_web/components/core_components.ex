defmodule PapricaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PapricaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PapricaWeb.Gettext, "errors", msg, opts)
    end
  end
